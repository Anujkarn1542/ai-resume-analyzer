...
export default function Compare() {
  ...
  const handleCompare = async () => {
    if (!v1 || !v2) {
      setError("Please select both analyses!");
      return;
    }
    if (v1 === v2) {
      setError("Please select two different analyses!");
        ...
        {history.length < 2 ? (
          ...
          >
            ...
            <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">
              You need at least 2 analyses to compare versions.
            </p>
            <a
              href="/dashboard"
          ...
          <>
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 mb-6"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
              ...
              <button
                ...
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 rounded-xl transition disabled:opacity-50"
              >
                {comparing ? "Comparing..." : "⚖️ Compare Versions"}
              </button>
            </motion.div>
              ...
              >
                ...
                <div className={`rounded-2xl p-6 text-center border ${
                  ...
                  <p className={`text-2xl font-black ${
                    result.improved ? "text-green-400" : "text-red-400"
                  }`}>
                    {result.improved ? "Resume Improved!" : "Score Decreased"}
                  </p>
